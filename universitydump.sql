...
CREATE TABLE `faculty_interests` (
  ...
  CONSTRAINT `faculty_interests_interests` FOREIGN KEY (`interestID`) REFERENCES `interests` (`interestID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `faculty_interests`
--

LOCK TABLES `faculty_interests` WRITE;
/*!40000 ALTER TABLE `faculty_interests` DISABLE KEYS */;
INSERT INTO `faculty_interests` VALUES (1,1),(2,1),(3,1),(1,2),(2,2),(3,2),(4,2),(1,3),(2,3),(1,4),(1,5),(2,5),(3,5),(1,6),(1,7),(1,8),(1,9),(1,10),(4,10),(1,11),(4,11),(1,12),(1,13),(4,14);
/*!40000 ALTER TABLE `faculty_interests` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `interests` VALUES (1,'Java'),(2,'C'),(3,'C++'),(4,'C#'),(5,'Ruby on Rails'),(6,'PHP'),(7,'Go'),(8,'Rust'),(9,'Python'),(10,'BASIC'),(11,'Machine Learning'),(12,'AI'),(13,'BASH'),(14,'Scripting'),(15,'HTML'),(16,'JavaScript'),(17,'Game Design'),(18,'Photography'),(19,'Game Development'),(20,'Web Development'),(21,'CSS'),(22,'Mobile Development');
...
CREATE TABLE `student_interests` (
  ...
  CONSTRAINT `student_interests_interests` FOREIGN KEY (`interestID`) REFERENCES `interests` (`interestID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `student_interests` VALUES (1,1),(2,1),(3,1),(4,1),(2,2),(1,4),(2,4),(1,9),(1,11),(1,14),(1,18);
...
-- Dump completed on 2021-04-17 11:15:40
